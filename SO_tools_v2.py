...
class SO_init:
    ...
    def simulate_so(self):
        ...
        newkey = 'Interference_' + self.bf.find_str_common(self.filenames_wf_0)
        ...
        newkey= 'Interference_' + self.bf.find_str_common(self.filenames_wf_1)
...
class Calculate_optimal_phase:
    ...
    def get_normalized_discriminability(self, time_delays):
        ...
        J = simps(abs(E1-E0)**2)/simps(abs(E1)**2+abs(E0)**2)*2
        return 1/J
